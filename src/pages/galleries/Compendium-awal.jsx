...
const compandiums = [
  { name: "THE BALI DREAM VILLA SEMINYAK", path: "/compendium-seminyak" },
  { name: "THE BALI DREAM SUITE VILLA SEMINYAK", path: "/compendium-suite" },
  { name: "THE BALI DREAM VILLA & RESORT ECHO BEACH CANGGU", path: "/compendium-canggu" },
];

export default function Compendiums() {
        ...
        <div className="flex-1 px-4 pb-10 flex flex-col justify-center items-center">
          ...
          rounded-xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
              {compandiums.map((compandium, i) => (
                <div
                  key={i}
                  // PERBAIKAN: Gunakan nama variabel yang sesuai (compandium.path)
                  onClick={() => navigate(compandium.path)}
                  className={`
